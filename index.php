    ...
    <section class="hero-section">
        ...
        <div class="hero-info">
            ...
            <p style="color: #57606f; line-height: 1.6;">
                Вітаю у моєму творчому просторі! Я займаюся проектуванням, розробкою сайтів та всього, що пов'язано з веб-технологіями. Даний веб-ресурс поєднує в собі технологічну адмін-панель керування замовленнями, каталог картин, та інтерактивну ігрову зону для взаємодії з клієнтами.
            </p>
        </div>
    </section>
